...
non-public info.
Prefer MIT license for my projects and ensure dependencies are license
compatible.
For UI, implement dark mode by default and don't support light mode unless
I explicitly ask.
Keep readme docs succinct; do not include file overviews and other info that is
easily learned by browsing the code.
